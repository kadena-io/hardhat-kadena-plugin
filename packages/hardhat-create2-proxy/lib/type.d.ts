import { DeployContractProperties, DeployedContractsOnChains } from '@kadena/hardhat-chainweb';
import { BaseContract, Signer } from 'ethers';
export type DeployUsingCreate2 = <T extends BaseContract = BaseContract, A extends unknown[] = unknown[]>(args: DeployContractProperties<A> & {
    salt: string;
